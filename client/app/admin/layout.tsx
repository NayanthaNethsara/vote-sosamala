...
export default function AdminLayout({
  ...
  if (loading || !user || !user.email || !env.adminEmails.includes(user.email)) {
    return <div className="p-8 text-center text-muted-foreground font-mono">Checking admin authorization...</div>;
  }
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-border px-6 sticky top-0 bg-background z-10">
          ...
          <h2 className="text-sm font-bold tracking-tight uppercase font-mono">Administration</h2>
        </header>
